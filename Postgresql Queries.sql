...
--** The above three queries didn't work because date column is stored as a text type, not as a DATE type. The EXTRACT(YEAR FROM date) function only works on columns of type DATE, TIMESTAMP, or similar.**


--**Fixing my query with the help of perplexity-ai**
```
